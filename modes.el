...
;; Make CPerl nicer with outline-minor-mode. The following cm-map definitions
;; define keys to be used after the prefix (M-o) is typed.
...
;; Define a better outline structure for Perl files
...
;; More customizations for CPerl and outline
