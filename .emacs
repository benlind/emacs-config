...
;; Disable autopair for certain modes:
(dolist (hk (list 'web-mode-hook 'c-mode-common-hook))
  (add-hook hk
            #'(lambda ()
                (autopair-mode -1))))
...
;; Scrolling & Clicking
;(xterm-mouse-mode 1)          ;; Move point on click
;(setq mouse-wheel-progressive-speed nil) ;; Make scrolling not accelerate
